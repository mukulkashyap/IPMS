...
var ModalPopups = {
    ...
    YesNoCancel: function (id, title, question, parameters) {
        ...
        //parameters.onYes = "javascript:alert('hi')";
        //parameters.onNo = "";

        //Create layers
        var myLayers = ModalPopups._createAllLayersNew(id, title, question, parameters);
        var oPopupBody = myLayers[4];
    ...
    _createAllLayers: function (id, title, message, parameters) {
        ...
        for (x in bt) {
            if (bt[x] == "ok")
                oPopupFooter.innerHTML += "<input name='" + id + "_okButton' id='" + id + "_okButton' type=button value='" + okButtonText + "' style='font-family:Verdana,Arial; font-size:8pt; border: solid 1px #859DBE; background-color: white; width:75px; height:20px; margin-right: 5px; margin-left: 5px;' title='" + okButtonText + "' onclick='" + onOk + "'/>";
            if (bt[x] == "yes")
                oPopupFooter.innerHTML += "<input name='" + id + "_yesButton' id='" + id + "_yesButton' type=button value='" + yesButtonText + "' style='font-family:Verdana,Arial; font-size:8pt; border: solid 1px #859DBE; background-color: white; width:75px; height:20px; margin-right: 5px; margin-left: 5px;' title='" + yesButtonText + "' onclick='" + onYes + "'/>";
            if (bt[x] == "no")
                oPopupFooter.innerHTML += "<input name='" + id + "_noButton' id='" + id + "_noButton' type=button value='" + noButtonText + "' style='font-family:Verdana,Arial; font-size:8pt; border: solid 1px #859DBE; background-color: white; width:75px; height:20px; margin-right: 5px; margin-left: 5px;' title='" + noButtonText + "' onclick='" + onNo + "'/>";
            if (bt[x] == "cancel")
                oPopupFooter.innerHTML += "<input name='" + id + "_cancelButton' id='" + id + "_cancelButton' type=button value='" + cancelButtonText + "' style='font-family:Verdana,Arial; font-size:8pt; border: solid 1px #859DBE; background-color: white; width:75px; height:20px; margin-right: 5px; margin-left: 5px;' title='" + cancelButtonText + "' onclick='" + onCancel + "'/>";
        }
    ...
    _createAllLayersNew: function (id, title, message, parameters) {
        //Create all 6 layers for; BackGround, Popup, Shadow, PopupTitle, PopupBody, PopupFooter
        var oBackground = ModalPopupsSupport.makeLayer(id + '_background', true, null);        // 0
        var oPopup = ModalPopupsSupport.makeLayer(id + '_popup', true, null);                  // 1
        var oShadow = ModalPopupsSupport.makeLayer(id + '_shadow', true, null);                // 2
        ...
        for (x in bt) {
            if (bt[x] == "ok")
                oPopupFooter.innerHTML += "<input name='" + id + "_okButton' id='" + id + "_okButton' type=button value='" + okButtonText + "' style='font-family:Verdana,Arial; font-size:8pt; border: solid 1px #859DBE; background-color: white; width:250px; height:20px; margin-right: 5px; margin-left: 5px;' onclick='" + onOk + "'/>";
            if (bt[x] == "yes")
                oPopupFooter.innerHTML += "<input name='" + id + "_yesButton' id='" + id + "_yesButton' type=button value='" + yesButtonText + "' style='font-family:Verdana,Arial; font-size:8pt; border: solid 1px #859DBE; background-color: white; width:250px; height:20px; margin-right: 5px; margin-left: 5px;' onclick='" + onYes + "'/>";
            if (bt[x] == "no")
                oPopupFooter.innerHTML += "<input name='" + id + "_noButton' id='" + id + "_noButton' type=button value='" + noButtonText + "' style='font-family:Verdana,Arial; font-size:8pt; border: solid 1px #859DBE; background-color: white; width:270px; height:20px; margin-right: 5px; margin-left: 5px;' onclick='" + onNo + "'/>";
            if (bt[x] == "cancel")
    ...
    _styleAllLayers: function (id, parameters, allLayers) {
        ...
        var cssPopup = "display:inline; position:absolute; z-index: " + (zIndex + 2) + "; background-color:white; color:black; border:solid 1px " + parameters.borderColor + "; padding:0px;"; // background-color:#EEF1F2
        ...
        objXml.onreadystatechange = function () {
            if (objXml.readyState == 4) {
                ...
                var html = "<div  style='overflow-y: scroll; position:absolute; " +
                    "top:5px; padding:0px ; left:5px; height:" + (parameters.height - 65) + "px; " +
...
var ModalPopupsSupport = {
    ...
    centerElement: function (elem, add, noleft) {
        ...
        if (top != 0) {
            if (ModalPopupsDefaults.ModalTop != '') top = ModalPopupsDefaults.ModalTop;
        }
